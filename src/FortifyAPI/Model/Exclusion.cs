...
namespace FortifyAPI.Model
{
    ...
    public partial class Exclusion :  IEquatable<Exclusion>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Value">URL fragment to exclude from scanning..</param>
        public Exclusion(string Value = default(string))
        {
            this.Value = Value;
        }
        
        /// <summary>
        /// URL fragment to exclude from scanning.
        /// </summary>
        /// <value>URL fragment to exclude from scanning.</value>
